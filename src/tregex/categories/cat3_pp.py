...
S_NP_NP_VP = f"'(S[<1{sc.S_NP_1}|<1{sc.S_NP_2}|<1{sc.S_NP_3}|<1{sc.S_NP_D_JJ}|<1{sc.S_NP_JJ}|<1{sc.S_NP_JJS}|<1{sc.S_NP_D_JJS}|<1{S_NP_PP_1}|<1{S_NP_PP_2}|<1{S_NP_PP_3}|<1{S_NP_JJ_PP}][<2{sc.S_NP_1}|<2{sc.S_NP_2}|<2{sc.S_NP_3}|<2{sc.S_NP_D_JJ}|<2{sc.S_NP_JJ}|<2{sc.S_NP_JJS}|<2{sc.S_NP_D_JJS}|<2{S_NP_PP_1}|<2{S_NP_PP_2}|<2{S_NP_PP_3}|<2{S_NP_JJ_PP}][<3{sc.S_VP}|<3{sc.S_VP_O}|<3{sc.S_VP_OO}|<3{sc.S_VP_C}|<3{sc.S_VP_O_JJ}|<3{sc.S_VP_O_JJS}<3{S_VP_PP}|<3{S_VP_O_PP}|<3{S_VP_C_PP}|<3{S_VP_O_JJ_PP}|<3{S_VP_O_JJS_PP}|<3{S_VP_ADVP_PP}|<3{S_VP_NP_ADVP_PP}|<3{S_VP_PP_ADVP}|<3{S_VP_NP_PP_ADVP}])'"
...
if __name__ == "__main__":
    ...
    pattern_file_path = os.path.join(output_dir, "pp.txt")
