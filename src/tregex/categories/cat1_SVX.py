...
S_NP_1 = "(NP<:/NN|DT|PRP|CD|FW|VBG|EX|WP|QP/)"

#Two item simple noun phrase, e.g. a magnet, the bear, my back tends to be on the object position

S_NP_2 = "(NP<1/NN|DT|PRP|CD|UH|FW|VBG|WP|QP/<2/^NN|DT|PRP|CD|FW|WP/!<3__)"

#Two item simple noun phrase, e.g. a magnet men, the pet store

S_NP_3 = "(NP<1/NN|DT|PRP|CD|UH|FW|WP|QP/<2/^NN|DT|PRP|CD|FW|VBG|WP|QP/<3/^NN|DT|PRP|CD|FW|WP/!<4__)"

#Simple NP with a JJ

S_NP_D_JJ = "(NP<1/DT|PRP|CD|UH|VBG|QP/<2/^JJ/<3/^NN|DT|PRP|CD|VBG/!<4__)"

S_NP_JJ = "(NP<1/^JJ/<2/^NN|DT|PRP|CD|VBG|QP/!<3__)"

#Simple NP: the best

S_NP_JJS = "(NP<:/^JJ/)"

S_NP_D_JJS = "(NP<1/DT|PRP|CD|UH|QP/<2/^JJ/!<3__)"
...
# NP det Noun: a cat
NP_2_D = f"'{S_NP_2}!>__'"
NP_2_D_P = f"'(NP<1/DT|PRP|CD|UH|VBG|FW|QP/<2/^NN|DT|PRP|CD|VBG|UH|FW/<3{P}!<4__)!>__'"
...
NP_3_D_P = f"'(NP<1/DT|PRP|CD|UH|VBG|QP/<2/^NN|DT|PRP|CD|VBG|UH|QP/<3/^NN|DT|PRP|CD|VBG|UH/<4{P}!<5__)!>__'"
NP_NP_3 = f"'(NP[<1{S_NP_1}|<1{S_NP_2}|<1{S_NP_3}][<2{S_NP_1}|<2{S_NP_2}|<2{S_NP_3}][<3{S_NP_1}|<3{S_NP_2}|<3{S_NP_3}]!<3__)!>__'"


# det JJ N: a blue cat 
NP_3_D_JJ_N = "'(NP<1/DT|PRP|CD|UH|QP/<2/^JJ/<3/^NN|DT|PRP|CD|VBG/!<4__)!>__'"
NP_3_D_JJ_N_P = f"'(NP<1/DT|PRP|CD|UH|QP/<2/^JJ/<3/^NN|DT|PRP|CD|VBG/<4{P}!<5__)!>__'"
...
# JJ NN NN
NP_JJ_N_N = "'(NP<1/JJ/<2/^NN|DT|PRP|CD|QP/<3/^NN|DT|PRP|CD|VBG/!<4__)!>__'"
NP_JJ_N_N_P = f"'(NP<1/JJ/<2/^NN|DT|PRP|CD|QP/<3/^NN|DT|PRP|CD|VBG/<4{P}!<5__)!>__'"
...
if __name__ == "__main__":
    ...
    pattern_file_path = os.path.join(output_dir, "SVX.txt")
